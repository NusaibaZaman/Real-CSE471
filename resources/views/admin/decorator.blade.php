...
@include('admin.header')
    <div class="page-wrapper mdc-toolbar-fixed-adjust">
        <main class="content-wrapper1">
            <div class="page-content">
                <form action="{{route('add_decorator') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="div_center">
                        <label>Interior Decorator Name</label> 
    ...
    <div class="page-wrapper mdc-toolbar-fixed-adjust">
        <main class="content-wrapper">
            <div class="page-content"> -->
                    <h1 class="title_deg">All Decorator Posts</h1>
                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table_deg">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $singlePost->information}}</td>
                                    <td>{{ $singlePost->number}}</td>
                                    <td>
                                        <img class="img_deg" src="decoratorimage/{{ $singlePost->image }}">
                                    </td>
                                </tr>
                                @endforeach
                            </table>
