...
@include('admin.header')
    <div class="page-wrapper mdc-toolbar-fixed-adjust">
        <main class="content-wrapper1">
            <div class="page-content">
                <form action="{{route('add_developer') }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="page-wrapper mdc-toolbar-fixed-adjust">
        <main class="content-wrapper">
            <div class="page-content"> -->
                    <h1 class="title_deg">All Developer Posts</h1>
                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table_deg">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img class="img_deg" src="developerimage/{{ $singlePost->image }}">
                                    </td>
                                </tr>
                                @endforeach
                            </table>
